...
class LeadgerReportView extends StatefulWidget {
  final Function onViewClick;

  LeadgerReportView({Key? key, required this.onViewClick}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _LeadgerReportView();
  }
}

class _LeadgerReportView extends State<LeadgerReportView>
